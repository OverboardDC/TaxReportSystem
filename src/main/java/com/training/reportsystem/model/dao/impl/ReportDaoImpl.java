...
public class ReportDaoImpl implements ReportDao {
    ...
    public List<Report> findAll() {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(DaoUtil.getQuery(Queries.FIND_ALL_REPORTS))) {
    ...
    public Report getById(Long id) {
        Report report = null;
        try (PreparedStatement preparedStatement = connection.prepareStatement(DaoUtil.getQuery(Queries.GET_REPORT_BY_ID))) {
    ...
    public void create(Report report) {
        try (PreparedStatement preparedStatement = connection.prepareStatement(DaoUtil.getQuery(Queries.CREATE_REPORT))) {
    ...
    public void update(Report report) {
        try (PreparedStatement preparedStatement = connection.prepareStatement(DaoUtil.getQuery(Queries.UPDATE_REPORT))) {
    ...
    public void delete(Long id) {
        try (PreparedStatement preparedStatement = connection.prepareStatement(DaoUtil.getQuery(Queries.DELETE_REPORT))) {
            preparedStatement.setLong(1, id);
            preparedStatement.executeUpdate();
        } catch (SQLException e) {
            logger.error(LoggerMessages.SQL_EXCEPTION);
    ...
    public void approveReport(Long reportId) {
        try (PreparedStatement preparedStatement = connection.prepareStatement(DaoUtil.getQuery(Queries.APPROVE_REPORT))) {
    ...
    public void rejectReport(Long reportId, String rejectReason) {
        try (PreparedStatement preparedStatement = connection.prepareStatement(DaoUtil.getQuery(Queries.REJECT_REPORT))) {
